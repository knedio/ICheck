<div class="container-fluid">
  ...
  <div class="tab-content" >
    <div class="tab-pane active" id="profile">
      ...
      <div class="col-lg-8">
        <form method="POST" class="form-horizontal" action="<?php echo base_url();?>InstructorController/updateProfile">
          <div class="form-group form-group-sm">
            <label class="col-sm-6 control-label">User Number :</label>
            <div class="col-sm-6">
              <input type="text" class="form-control" readonly value="<?php echo $user['user_no']; ?>">
            </div>
          </div>
          <div class="form-group form-group-sm">
            <label class="col-sm-6 control-label">Tags ID :</label>
            <div class="col-sm-6">
              <input type="text" class="form-control" readonly value="<?php echo $user['tags_id']; ?>">
            </div>
          </div>
          <div class="form-group form-group-sm">
          ...
          <div class="form-group form-group-sm">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" readonly value="<?php echo $user['position_type']; ?>">
            </div>
          </div>
    ...
    <div class="tab-pane" id="password">
      <form class="form-horizontal" action="<?php echo base_url();?>InstructorController/update_password" method="post">
